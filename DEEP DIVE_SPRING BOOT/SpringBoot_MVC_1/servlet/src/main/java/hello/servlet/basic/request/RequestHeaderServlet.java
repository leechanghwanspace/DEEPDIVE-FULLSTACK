...
public class RequestHeaderServlet extends HttpServlet {
    ...
    @Override // public 아니다 잠겨있는 자물쇠 모양 protected 임.
...
//    }
    ...
    private void printHeaderUtils(HttpServletRequest request) {
        ...
        System.out.println("request.getLocale() = " + request.getLocale()); System.out.println(); // request.getLocale로 하면 가장 상단에 있는게 자동으로 뽑힘
